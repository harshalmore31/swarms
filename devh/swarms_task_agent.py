...
class SwarmsTaskAgent:
    ...
    def run(self) -> None:
        ...
        console.print("\n[cyan]Should the AI process tasks autonomously?[/]")
        console.print("Answer 'yes' to let AI handle tasks automatically, or")
        console.print("'no' to use interactive chat mode and work together on tasks.")
        
        mode = Prompt.ask("Your choice", choices=["yes", "no"], default="no")
